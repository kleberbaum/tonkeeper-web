...
export interface IAppContext {
    ...
    /**
     * Gates the BIP39 multichain create/import flow. Legacy TON-standard
     * and MAM paths remain available regardless. See CLAUDE.md →
     * "Scope of the flag" for the contract.
     */
