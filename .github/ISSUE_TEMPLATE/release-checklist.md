...
> **Docs:** [Release Process](../../CONTRIBUTING.md#release-process) > **Pre-release:** >
> `v[VERSION]-rc.1` · **Release:** `v[VERSION]` > **GitHub release:** >
> https://github.com/tonkeeper/tonkeeper-web/releases/tag/v[VERSION]
